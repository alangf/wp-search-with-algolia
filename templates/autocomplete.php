...
<script type="text/html" id="tmpl-autocomplete-term-suggestion">
  <a class="suggestion-link" href="{{ data.permalink }}" title="{{ data.name }}">{{data.images}}
	<span class="suggestion-post-title">{{{ data._highlightResult.name.value }}}</span>
		  <# if ( data._highlightResult.description.value ) { #>
			<span class="suggestion-post-content">{{{ data._highlightResult.description.value }}}</span>
			<# } #>
  </a>
</script>
